  ...
  return (
    <div className='course-continer'>
      ...
      <div className='course-1'>
        <SingleCourses status='' bgColor='white' textColour='white' course='Business English' specification='Grammar' />
      </div>
      <div className='course-2'>
        <SingleCourses  bgColor='white' textColour='white' course='Common English' specification='Phrasal Verbs' />
      </div>
      <div className='course-3'>
        <SingleCourses  bgColor='white' textColour='white' course='Business Spanish' specification='Vocabulary' />
      </div>
    </div>
  )
}
